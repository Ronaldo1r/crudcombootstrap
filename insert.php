...
<div class="col-md-6 col-md-offset-3">
    <div class="box">
        <h3><i class="glyphicon glyphicon-plus"></i>&nbsp;Add new
user</h3>
...
class="form-control"><br>
        ...
        <input type="text" name="contact" id="contact" clas="form-control"><br>
        <br>
        <input type="submit" name="addnew" class="btn btn-success"
value="Add New">
    </form>
</div>
</div>
